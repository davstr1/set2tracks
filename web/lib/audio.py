...
# THIS STUFF SUGGESTED BY GPT IN an intent to make things faster, well, eat half the files
# def cut_audio(file_path, chapters=[], segment_length_s=120, frame_rate=None, segments_dir='segments'):
#     print('cutting audio')
#     # Load the audio file
#     print('extracting audio segment (this may take a while)')
#     audio = AudioSegment.from_file(file_path)

#     if frame_rate:
#         audio = audio.set_frame_rate(frame_rate)
#     print('Audio segment extracted')
...
#     return [f"{segments_dir}/segment_{i}.opus" for i in range(num_segments)]
